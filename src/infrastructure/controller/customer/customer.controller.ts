...
export class CustomerController {
    ...
    public async getAllCtrl(req: Request, res: Response) {
        try {
            ...
            const { cus_fullname, cus_email, rou_uuid, page, perPage, field_order, cus_orderby } = req.query;
            ...
            if (page && perPage) {
                const customers = await this.customerUseCase.getCustomers(cmp_uuid, getStringFromQuery(cus_fullname), getStringFromQuery(cus_email), getStringFromQuery(rou_uuid), getStringFromQuery(field_order), getStringFromQuery(cus_orderby))
