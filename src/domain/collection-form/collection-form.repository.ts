import { CollectionFormEntity, CollectionFormUpdateData } from "./collection-form.entity";
...
export interface CollectionFormRepository {
    ...
    updateCollectionForm(cmp_uuid: string, cfrm_uuid: string, collectionForm: CollectionFormUpdateData): Promise<CollectionFormEntity | null>;
