import { DetailModelItemEntity, DetailModelItemUpdateData } from "./detail-model-item.entity";

export interface DetailModelItemRepository {
    getDetailModelItems(cmp_uuid: string): Promise<DetailModelItemEntity[] | null>;
    ...
    updateDetailModelItem(cmp_uuid: string, itm_uuid: string, cmpitm_uuid: string, mitm_uuid: string, dmitm_uuid: string, modelItem: DetailModelItemUpdateData): Promise<DetailModelItemEntity | null>;
