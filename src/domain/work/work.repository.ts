...
export interface WorkRepository {
    getWorks(cmp_uuid: string, wrk_dateFrom: Date | undefined, wrk_dateTo: Date | undefined, wrk_fullname: string | undefined, wrks_uuid: string | undefined, field_order: string | undefined, wrk_orderby: string | undefined): Promise<WorkEntity[] | null>;
    ...
    updateWorksOrder(cmp_uuid: string, orders: { wrk_uuid: string, wrk_order: number }[]): Promise<boolean>;
}