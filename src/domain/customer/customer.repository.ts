...
export interface CustomerRepository {
    getCustomers(cmp_uuid: string, cus_fullname: string | undefined, cus_email: string | undefined, field_order: string | undefined, cus_orderby: string | undefined): Promise<CustomerEntity[] | null>;
