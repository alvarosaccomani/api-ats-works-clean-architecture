...
export interface CustomerRepository {
    getCustomers(cmp_uuid: string, cus_fullname: string | undefined, cus_email: string | undefined, rou_uuid: string | undefined, field_order: string | undefined, cus_orderby: string | undefined): Promise<CustomerEntity[] | null>;
    ...
    updateCustomersOrder(cmp_uuid: string, rou_uuid: string, orders: { cus_uuid: string, cus_order: number }[]): Promise<boolean>;
}