import { WorkStateEntity, WorkStateUpdateData } from "./work-state.entity";

export interface WorkStateRepository {
    getWorkStates(cmp_uuid: string): Promise<WorkStateEntity[] | null>;
    ...
    updateWorkState(cmp_uuid: string, wrks_uuid: string, workState: WorkStateUpdateData): Promise<WorkStateEntity | null>;
